      ...
      >
        <div class="flex items-start justify-between gap-3">
          <div class="flex items-center gap-3">
            <div class="w-12 h-12 rounded-xl bg-slate-950 border border-orange-500/60 p-2.5 flex items-center justify-center shadow-[0_0_15px_rgba(255,122,0,0.4)] flex-shrink-0">
