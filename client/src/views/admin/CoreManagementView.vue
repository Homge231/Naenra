      ...
      <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div class="shrink-0 flex items-center gap-3">
          ...
          <button 
            ...
            class="px-5 py-3 bg-gradient-to-r from-cyan-600 via-teal-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 text-white rounded-xl text-xs font-black uppercase tracking-wider shadow-[0_0_20px_rgba(6,182,212,0.35)] hover:shadow-[0_0_25px_rgba(6,182,212,0.55)] border border-cyan-400/40 transition-all flex items-center gap-2 cursor-pointer active:scale-95"
          >
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="text-lg font-black text-white uppercase tracking-wide">
                {{ formMode === 'create' ? 'CREATE NEW SUPPORT CORE' : 'EDIT CORE CONFIGURATIONS' }}
              </h3>
              <p class="text-xs text-cyan-400 font-mono">Game Engine Parameter Tuning</p>
            </div>
          </div>
